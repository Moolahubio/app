 ...
 * set (production secrets). The client authenticates with Privy, then posts its
 * access token to /api/auth/privy, which verifies it here and establishes our
 * own session — so the rest of the app is unchanged.
 */
