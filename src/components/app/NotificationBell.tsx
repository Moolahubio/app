    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 z-50 mt-2 w-[22rem] max-w-[calc(100vw-2rem)] overflow-hidden rounded-3xl border border-ink-900/[0.08] bg-white shadow-card-hover">
