...
import { userActivity, type ActivityRow } from "@/lib/server/ledger";
...
function groupByDay(items: ActivityRow[]) {
  const groups: Record<string, ActivityRow[]> = {};
  for (const item of items) {
    const key = item.createdAt.toLocaleDateString("en-US", {
      month: "long",
      day: "numeric",
      year: "numeric",
    });
